...
# Reemplazar líneas 350-352:
$panelRight.Controls.Add($dgvResults)
$panelRight.Controls.Add($txtQuery)
...
$btnConnectDb.Add_Click({
    ...
    # ————— Controles de perfil —————
    $lblProfile = Create-Label -Text "Perfil de conexión" -Location (10,20) -Size (100,20)
    $cmbProfiles = Create-ComboBox -Location (120,20) -Size (250,20) -DropDownStyle DropDownList
    $profiles = @{}
    $iniPaths = @(
    ...
    $labelServer   = Create-Label   -Text "Servidor SQL"    -Location (10, 60)  -Size (100,20)
    $txtServer     = Create-TextBox -Location (120, 60)    -Size (250,20)
    $lblDatabase   = Create-Label   -Text "Base de Datos"   -Location (10, 90)  -Size (100,20)
    $txtDatabase   = Create-TextBox -Location (120, 90)    -Size (250,20)
    $lblPassword   = Create-Label   -Text "Contraseña"      -Location (10,120)  -Size (100,20)
    $txtPassword   = Create-TextBox -Location (120,120)    -Size (250,20) -UseSystemPasswordChar $true
