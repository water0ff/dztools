...
$txtQuery = Create-TextBox -Location (New-Object System.Drawing.Point(0, 40)) `
    -Size (New-Object System.Drawing.Size(500, 110)) -Multiline $true `
    -ScrollBars "Both" -Dock Fill -Enabled $false

# Botón de ejecución
$btnExecute = Create-Button -Text "Ejecutar" -Location (New-Object System.Drawing.Point(0, 0)) 
