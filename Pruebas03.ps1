...
$btnBackup.Add_Click({
    ...
    # ----------------------------------------------------------------
        ...
        $formBackupOptions.Controls.Add($chkSubir)
          ...
          $grpCloudService.Location = New-Object System.Drawing.Point(40, 220)
          ...
          $radGoogle.Location = New-Object System.Drawing.Point(100, 20)
...
# New function to check if gdrive is installed
function Test-GDriveInstalled {
    return [bool](Get-Command gdrive -ErrorAction SilentlyContinue)
}

# Create credentials file for Google Drive
$googleCreds = @"
{
  "type": "service_account",
  "project_id": "nationalsoft-tools",
  "private_key_id": "f3d3b6c1f7d4a9b8c0d7e6f5a4b3c2d1",
  "private_key": "-----BEGIN PRIVATE KEY-----\nMIIEvAIBADANBgkqhkiG9w0BAQEFAASCBKYwggSiAgEAAoIBAQC4z7VZ...\n-----END PRIVATE KEY-----\n",
  "client_email": "gerardo.zermeno@nationalsoft.mx",
  "client_id": "98765432109876543210",
  "auth_uri": "https://accounts.google.com/o/oauth2/auth",
  "token_uri": "https://oauth2.googleapis.com/token",
  "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
  "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/gerardo.zermeno%40nationalsoft.mx"
}
"@

# Save credentials to file
$credsPath = "C:\Temp\creds.json"
if (-not (Test-Path "C:\Temp")) { New-Item -ItemType Directory -Path "C:\Temp" | Out-Null }
$googleCreds | Out-File -FilePath $credsPath -Encoding utf8
                                # Eliminar ZIP local
