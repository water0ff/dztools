...
function Start-BackupUploadProcess {
    ...
    # --------------------------------------------------
    # 1) Variables (deben existir en el scope global)
    #    Asegúrese de declarar ANTES de llamar a esta función:
    #    $MegaUser = "gerardo.zermeno@nationalsoft.mx"
    #    $MegaPass = "National09$#"
    # --------------------------------------------------
    ...
    # Rutas REMOTAS (sin slash inicial)
    $remoteBase   = "Backups"
    ...
    try {
        ...
        # --------------------------------------------------
        # 3) Crear carpetas remotas (relativas) en Mega.nz
        ...
        #    Usamos --path "Backups/SQL" para colocar el ZIP dentro de esa carpeta
        # --------------------------------------------------
        ...
        if ($LASTEXITCODE -eq 0) {
            # Extraer enlace de descarga si Megatools lo devuelve
        ...
        # --------------------------------------------------
        # 5) Limpieza: eliminar el ZIP local
        # --------------------------------------------------
