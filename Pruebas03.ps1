        ...
        $global:backupTimer.Add_Tick({
            if ($global:asyncResult -ne $null -and $global:asyncResult.IsCompleted) {
                ...
                try {
                    ...
                    [System.Windows.Forms.MessageBox]::Show("Backup completado exitosamente en:`n$backupPath", "Éxito",
                        [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Information)
                    Write-Host "Backup guardado en: $backupPath" -ForegroundColor Green  # Línea nueva
                }
                catch [System.Data.SqlClient.SqlException] {
                    if ($_.Exception.Class -ne 0) {
                        [System.Windows.Forms.MessageBox]::Show("Error en backup: $($_.Exception.Message)", "Error",
                            [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Error)
                    }
                }
                finally {
