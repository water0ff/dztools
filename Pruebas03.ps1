...
# Crear el formulario
    ...
    $boldFont = New-Object System.Drawing.Font("Segoe UI", 10, [System.Drawing.FontStyle]::Bold)
                                                                                                        $version = "Alfa 250507.1404"  # Valor predeterminado para la versión
...
# Añadir indicador visual de estado
          $picConnectionStatus = New-Object System.Windows.Forms.PictureBox
          $picConnectionStatus.Size = New-Object System.Drawing.Size(20,20)
          $picConnectionStatus.Location = New-Object System.Drawing.Point(650, 25)
      ...
      $grpAccionesSQL.Location = New-Object System.Drawing.Point(10, 120)
      $grpAccionesSQL.Visible = $false
      $tabProSql.Controls.Add($grpAccionesSQL)
# Mover los botones SQL a este grupo
        $btnReviewPivot.Parent = $grpAccionesSQL
        $btnFechaRevEstaciones.Parent = $grpAccionesSQL
        $btnEliminarServidorBDD.Parent = $grpAccionesSQL
        $grpMySQL = New-Object System.Windows.Forms.GroupBox
        $grpMySQL.Text = "Respaldo MySQL"
        $grpMySQL.BackColor = [System.Drawing.Color]::FromArgb(255,230,230)
        $grpMySQL.Size = New-Object System.Drawing.Size(680, 80)
        $grpMySQL.Location = New-Object System.Drawing.Point(10, 280)
        $tabProSql.Controls.Add($grpMySQL)
# Mover y modificar el botón de respaldo
      $btnRespaldarRestcard.Parent = $grpMySQL
      $btnRespaldarRestcard.BackColor = [System.Drawing.Color]::FromArgb(255,200,200)
