...
# Crear el formulario
    ...
    $boldFont = New-Object System.Drawing.Font("Segoe UI", 10, [System.Drawing.FontStyle]::Bold)
                                                                                                        $version = "Alfa 250429.1214"  # Valor predeterminado para la versión
    ...
    Write-Host "Intentando guardar el usuario..." -ForegroundColor White
        ...
        if (-not $username -or -not $password -or -not $userType) {
            ...
            try {
                        ...
                        # Validar complejidad (opcional, según política del sistema)
                        ...
                        if (-not ($hasUpper -and $hasLower -and ($hasNumber -or $hasSpecial))) {
                            throw [Microsoft.PowerShell.Commands.InvalidPasswordException]::new()
                        }
