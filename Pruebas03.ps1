...
$btnBackup.Add_Click({
    ...
    try {
        ...
        # 2. Construcción de la ruta de backup
        ...
        try {
            ...
            Write-Host "Error | Error de permisos en la ruta de backup." -ForegroundColor Red
            return
        }
        ...
        $global:backupProgressForm.Size = New-Object System.Drawing.Size(400,120)
        $global:backupProgressForm.StartPosition = "CenterScreen"
        $global:backupProgressForm.TopMost = $true
        $global:backupProgressForm.FormBorderStyle = [System.Windows.Forms.FormBorderStyle]::FixedDialog
        ...
        $lblStatus = Create-Label `
            -Text "Por favor espere, realizando backup..." `
            -Location (New-Object System.Drawing.Point(10,50)) `
        ...
        $global:backupProgressForm.Controls.AddRange(@($progressBar, $lblStatus, $btnCancel))
        $global:backupProgressForm.Show()

        # 5. Timer para checar fin de operación
        $global:backupTimer = New-Object System.Windows.Forms.Timer
        $global:backupTimer.Interval = 500

        # 6. Configuración de la conexión y comando SQL
        ...
        # 7. Iniciar backup asíncrono y timer
        $global:asyncResult = $global:backupCommand.BeginExecuteNonQuery($null, $null)
        ...
        $btnCancel.Add_Click({
            try {
                ...
                [System.Windows.Forms.MessageBox]::Show("Backup cancelado","Información",[System.Windows.Forms.MessageBoxButtons]::OK,[System.Windows.Forms.MessageBoxIcon]::Information)
        ...
        # 8. Tick para detectar fin de backup
        $global:backupTimer.Add_Tick({
            if ($global:asyncResult.IsCompleted) {
                ...
                try {
                    ...
                    [System.Windows.Forms.MessageBox]::Show("Backup completado en:`n$global:backupPath","Éxito",[System.Windows.Forms.MessageBoxButtons]::OK,[System.Windows.Forms.MessageBoxIcon]::Information)
                    Write-Host "Backup completado en $global:backupPath" -ForegroundColor Green
                    Invoke-Item (Split-Path $global:backupPath)
                }
                catch {
                    [System.Windows.Forms.MessageBox]::Show("Error en backup: $($_.Exception.Message)","Error",[System.Windows.Forms.MessageBoxButtons]::OK,[System.Windows.Forms.MessageBoxIcon]::Error)
        ...
        [System.Windows.Forms.MessageBox]::Show("Error al iniciar backup: $($_.Exception.Message)","Error",[System.Windows.Forms.MessageBoxButtons]::OK,[System.Windows.Forms.MessageBoxIcon]::Error)
        Write-Host "Error al iniciar backup: $($_.Exception.Message)" -ForegroundColor Red
        if ($global:backupConnection.State -eq 'Open') { $global:backupConnection.Close() }
        $global:backupProgressForm.Close()
    }
})
...
$formPrincipal.Add_FormClosing({
    if ($global:backupConnection -and $global:backupConnection.State -eq 'Open') {
