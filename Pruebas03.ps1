...
function Show-UploadPrompt {
    ...
    $label.AutoSize = $true
    $formShow-UploadPrompt.Controls.Add($label)
    ...
    $formShow-UploadPrompt.Controls.Add($megaPic)
    ...
    $formShow-UploadPrompt.Controls.Add($zipPic)
    ...
    $formShow-UploadPrompt.Controls.Add($btnYes)

    $btnNo = New-Object System.Windows.Forms.Button
    $btnNo.Text = "No"
    $btnNo.DialogResult = "No"
    $btnNo.Location = New-Object System.Drawing.Point(220, 180)
    $formShow-UploadPrompt.Controls.Add($btnNo)

    return $formShow-UploadPrompt.ShowDialog()
}
