...
$lstDatabases.Size = New-Object System.Drawing.Size(180, 200)
...
# Modificar la sección de creación de botones de conexión:
$btnConnectDb = Create-Button -Text "Conectar a BDD" -Location (New-Object System.Drawing.Point(10, 20)) `
    -BackColor ([System.Drawing.Color]::FromArgb(150, 200, 255)) -Size (New-Object System.Drawing.Size(180, 30))

$btnDisconnectDb = Create-Button -Text "Desconectar de BDD" -Location (New-Object System.Drawing.Point(10, 60)) `
    -BackColor ([System.Drawing.Color]::FromArgb(150, 200, 255)) -Size (New-Object System.Drawing.Size(180, 30)) -Enabled $false
