...
$btnBackup.Add_Click({
    ...
    try {
        ...
        # 2. Selección de Carpeta de Destino
        ...
        # 5. Creación del formulario de progreso
        ...
        # 6. Configuración de la conexión a SQL Server
        ...
        # 11. Manejador del Tick: fin de backup
