            ...
            if ($global:backupJob.State -eq 'Completed') {
                ...
                if (Test-Path $global:tempBackupFolder) {
                    ...
                    try {
                        ...
                        Update-Progress -Value 10 -Message "Verificando si megatools ya está disponible..." -WriteConsole
                        ...
                        Update-Progress -Value 40 -Message "Configurando megatools..." -WriteConsole
