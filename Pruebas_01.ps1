...
function Show-UploadPrompt {
    ...
    $btnYes.Location = New-Object System.Drawing.Point(120, 180)
    $formShowUploadPrompt.Controls.Add($btnYes)  # FIXED

    $btnNo = New-Object System.Windows.Forms.Button
    $btnNo.Text = "No"
    $btnNo.DialogResult = "No"
    $btnNo.Location = New-Object System.Drawing.Point(220, 180)
    $formShowUploadPrompt.Controls.Add($btnNo)  # FIXED
