...
# Crear el formulario
    ...
    $boldFont = New-Object System.Drawing.Font("Segoe UI", 10, [System.Drawing.FontStyle]::Bold)
                                                                                                        $version = "Alfa 250516.1233"  # Valor predeterminado para la versión
...
$btnAddUser.Add_Click({
    ...
    $txtUsername = Create-TextBox -Location (New-Object System.Drawing.Point(120, 20)) -Size (New-Object System.Drawing.Size(200, 20))
    $lblPassword = Create-Label -Text "Contraseña:" -Location (New-Object System.Drawing.Point(10, 60))
    $txtPassword = Create-TextBox -Location (New-Object System.Drawing.Point(120, 60)) -Size (New-Object System.Drawing.Size(200, 20)) -UseSystemPasswordChar $true
    $lblType     = Create-Label -Text "Tipo:" -Location (New-Object System.Drawing.Point(10, 100))
    $cmbType     = Create-ComboBox -Location (New-Object System.Drawing.Point(120, 100)) -Size (New-Object System.Drawing.Size(200, 20)) -Items @("Usuario estándar","Administrador")
    ...
    # Botones
    $btnCreate = Create-Button -Text "Crear"    -Location (New-Object System.Drawing.Point(50, 150))  -Size (New-Object System.Drawing.Size(100, 30))
    $btnCancel = Create-Button -Text "Cancelar" -Location (New-Object System.Drawing.Point(160, 150)) -Size (New-Object System.Drawing.Size(100, 30))
    $btnShow   = Create-Button -Text "Mostrar usuarios" -Location (New-Object System.Drawing.Point(270, 150)) -Size (New-Object System.Drawing.Size(130, 30))

    # Mostrar usuarios existentes
    $btnShow.Add_Click({
        Write-Host "`nUsuarios actuales en el sistema:`n" -ForegroundColor Cyan
        $users = Get-LocalUser
        Write-Host "{0,-25} {1,-20} {2,-12}" -f "Nombre","Tipo","Estado"
        Write-Host "{0,-25} {1,-20} {2,-12}" -f "------","----","------"
        foreach ($u in $users) {
            $estado = if ($u.Enabled) { 'Habilitado' } else { 'Deshabilitado' }
            # Intentar determinar tipo
            try {
                if ((Get-LocalGroupMember -Group $adminGroup -ErrorAction Stop) | Where-Object SID -EQ $u.SID) {
                    $tipo = 'Administrador'
                } elseif ((Get-LocalGroupMember -Group $userGroup -ErrorAction Stop) | Where-Object SID -EQ $u.SID) {
                    $tipo = 'Usuario estándar'
                } else {
                    $tipo = 'Miembro otro grupo'
                }
            } catch {
                $tipo = 'Tipo desconocido'
            }
            Write-Host "{0,-25} {1,-20} {2,-12}" -f $u.Name, $tipo, $estado
        }
    })
    ...
    # Agregar controles
    $formAddUser.Controls.AddRange(@($lblUsername,$txtUsername,$lblPassword,$txtPassword,$lblType,$cmbType,$btnCreate,$btnCancel,$btnShow))
