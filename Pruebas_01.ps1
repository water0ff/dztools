...
$btnBackup.Add_Click({
    try {
        ...
        $progressForm = Create-Form -Title "Progreso de Backup" -Size (400, 150)
        $progressBar = New-Object System.Windows.Forms.ProgressBar
        $progressBar.Size = New-Object System.Drawing.Size(380, 20)
        $progressBar.Location = New-Object System.Drawing.Point(10, 20)
        $lblProgress = Create-Label -Text "0% completado" -Location (10, 50) -Size (380, 20)
        $btnCancel = Create-Button -Text "Cancelar" -Location (150, 80) -Size (100, 30)
