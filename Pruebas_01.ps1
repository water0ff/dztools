...
# Añadir indicador visual de estado
          ...
          $picConnectionStatus.Image = [System.Drawing.Image]::FromFile("red_led.png") # Añadir imagen
...
# En el evento de conexión exitosa añadir:
      ...
      $picConnectionStatus.Image = [System.Drawing.Image]::FromFile("green_led.png")
# En la desconexión añadir:
      $grpAccionesSQL.Visible = $false
      $picConnectionStatus.Image = [System.Drawing.Image]::FromFile("red_led.png")
