...
# Descargar íconos si no existen
$megaIconPath = "$iconDir\mega_ico.png"
$7zipIconPath = "$iconDir\7zip_ico.png"

if (-not (Test-Path $megaIconPath)) {
    Invoke-WebRequest -Uri $megaIconUrl -OutFile $megaIconPath
    Write-Host "Ícono de Mega descargado."
}

if (-not (Test-Path $7zipIconPath)) {
    Invoke-WebRequest -Uri $7zipIconUrl -OutFile $7zipIconPath
    Write-Host "Ícono de 7-Zip descargado."
}
