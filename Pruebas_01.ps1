...
# Crear SplitContainer
$splitContainer = New-Object System.Windows.Forms.SplitContainer
$splitContainer.Dock = [System.Windows.Forms.DockStyle]::Fill
$splitContainer.SplitterDistance = 200
# Crear un SplitContainer interno para el área de consulta/resultados
...
$splitContainerRight.Orientation = [System.Windows.Forms.Orientation]::Vertical
$splitContainerRight.SplitterDistance = 150  # Ajustar altura del área de consulta
# Panel izquierdo
$panelLeft = New-Object System.Windows.Forms.Panel
$panelLeft.Dock = [System.Windows.Forms.DockStyle]::Fill
$panelLeft.AutoScroll = $true
# Agregar después de crear el SplitContainer:
$panelRight = $splitContainer.Panel2
$panelRight.Dock = [System.Windows.Forms.DockStyle]::Fill
# Crear botones CORRECTAMENTE con New-Object para Point
$btnConnectDb = Create-Button -Text "Conectar a BDD" `
...
$btnDisconnectDb = Create-Button -Text "Desconectar de BDD" `
...
$lstDatabases.Location = New-Object System.Drawing.Point(10, 100)
$lstDatabases.Size = New-Object System.Drawing.Size(180, 150)
$lstDatabases.CheckOnClick = $true
...
$tabProSql.Controls.Add($splitContainer)
...
$lstDatabases = New-Object System.Windows.Forms.CheckedListBox
$lstDatabases.Location = New-Object System.Drawing.Point(10, 100)
$lstDatabases.Size = New-Object System.Drawing.Size(180, 150)  # Ajustar altura
$lstDatabases.CheckOnClick = $true
# Modificar esta sección en tu código:
# Agregar controles al panel izquierdo
$panelLeft.Controls.AddRange(@($btnConnectDb, $btnDisconnectDb, $lstDatabases, $lblConnectionStatus))
$panelLeft.AutoScroll = $true
# TextBox para consultas
# Modificar la creación del TextBox de consultas
$txtQuery = Create-TextBox -Location (New-Object System.Drawing.Point(10, 40)) `
    -Size (New-Object System.Drawing.Size(500, 110)) -Multiline $true `
    -ScrollBars "Both" -Dock Fill -Enabled $false

# Botón de ejecución
$btnExecute = Create-Button -Text "Ejecutar" -Location (New-Object System.Drawing.Point(10, 20)) 
$btnExecute.Size = New-Object System.Drawing.Size(100, 30)

# CheckBox y ComboBox para consultas predefinidas
$chkPredefined = New-Object System.Windows.Forms.CheckBox
$chkPredefined.Text = "Sentencias predefinidas"
$chkPredefined.Location = New-Object System.Drawing.Point(110, 5)
$chkPredefined.Size = New-Object System.Drawing.Size(150, 20)

$cmbQueries = New-Object System.Windows.Forms.ComboBox
$cmbQueries.Location = New-Object System.Drawing.Point(260, 5)
...
$panelTop.Controls.AddRange(@($btnExecute, $chkPredefined, $cmbQueries))


# Configurar correctamente los paneles internos
$splitContainerRight.Panel1.Controls.Add($panelTop)  # Panel superior con botón
$splitContainerRight.Panel1.Controls.Add($txtQuery)  # Área de consulta debajo
$splitContainerRight.Panel2.Controls.Add($dgvResults) # Resultados abajo

# Agregar el SplitContainer derecho al panel principal derecho
$splitContainer.Panel2.Controls.Add($splitContainerRight)

# Con esto (usando un layout adecuado):
$panelRight.Controls.Add($panelTop)
$panelRight.Controls.Add($splitContainerRight)
$panelRight.Controls.AddRange(@($dgvResults, $txtQuery, $panelTop))
...
$script:predefinedQueries = @{
    ...
    "Fecha Revisiones" = "SELECT e.FECHAREV, b.estacion FROM bitacorasistema b INNER JOIN estaciones e ON b.estacion = e.idestacion"
...
# Eliminar estas líneas que están duplicando los botones en la pestaña Pro:
...
# En su lugar, dejar solo esta estructura:
$tabProSql.Controls.Add($splitContainer)  # Solo el SplitContainer en la pestaña Pro
...
$btnConnectDb.Add_Click({
    ...
    $btnOK.Add_Click({
        try {
            # Cadena + apertura de conexión
            $connStr = "Server=$($txtServer.Text);Database=$($txtDatabase.Text);User Id=sa;Password=$($txtPassword.Text);"
            ...
            # Obtener lista de bases ONLINE (excluyendo sistema)
            $query = @"
SELECT name
FROM sys.databases
...
ORDER BY name
"@
            $dbs = Execute-SqlQuery -server $global:server -database "master" -query $query

            # Llenar ListBox de DBs
            $lstDatabases.Items.Clear()
            foreach ($d in $dbs) {
                $lstDatabases.Items.Add($d.name)
            }

            # Actualizar UI: labels y botones
            $lblConnectionStatus.Text = "Conectado a: $($txtServer.Text)\`$\$/$($txtDatabase.Text)"
            ...
            [System.Windows.Forms.MessageBox]::Show(
                "Error al conectar: $($_.Exception.Message)",
                "Error de Conexión",
                [System.Windows.Forms.MessageBoxButtons]::OK,
                [System.Windows.Forms.MessageBoxIcon]::Error
            )
...
$btnExecute.Add_Click({
    try {
        $selectedDbs = $lstDatabases.CheckedItems
        if ($selectedDbs.Count -eq 0) {
            throw "Seleccione al menos una base de datos"
        }
        
        $results = @()
        foreach ($db in $selectedDbs) {
            $result = Execute-SqlQuery -server $global:server -database $db -query $txtQuery.Text
            $results += $result | Select-Object @{Name="Database";Expression={$db}}, *
        }
