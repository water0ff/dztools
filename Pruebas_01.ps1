...
# FUNCIÓN PARA COMPRIMIR Y SUBIR A TRANSFERNOW
function Start-BackupUploadProcess {
    ...
    $transferNowApiKey = "9595cca2-aa98-4274-9634-1b5981408a63"  # Usa tu API key
    ...
    try {
        ...
        # 3. Subir a TransferNow
        $headers = @{"X-Api-Key" = $transferNowApiKey}
        ...
        $response = Invoke-RestMethod -Uri "https://api.transfernow.net/v1/files" `
            -Method Post `
            -Headers $headers `
            -Form $body `
        ...
        Write-Host "Enlace de descarga: $downloadLink" -ForegroundColor Cyan

        [System.Windows.Forms.MessageBox]::Show(
            "Respaldo subido correctamente`nEnlace: $downloadLink`nContraseña: National09",
            "TransferNow - Éxito",
            [System.Windows.Forms.MessageBoxButtons]::OK,
            [System.Windows.Forms.MessageBoxIcon]::Information
        )
        ...
        [System.Windows.Forms.MessageBox]::Show(
            "Error durante la subida: $($_.Exception.Message)",
            "Error",
            [System.Windows.Forms.MessageBoxButtons]::OK,
            [System.Windows.Forms.MessageBoxIcon]::Error
        )
