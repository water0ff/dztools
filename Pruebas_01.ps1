...
# Descargar megatools (versión estable más reciente)
...
# Descargar y extraer
Invoke-WebRequest -Uri $megatoolsUrl -OutFile $megatoolsZip
Expand-Archive -Path $megatoolsZip -DestinationPath $megatoolsPath -Force
