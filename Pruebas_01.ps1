...
$btnBackup.Add_Click({
    ...
    try {
        ...
        [System.Windows.Forms.MessageBox]::Show(
            "Error permisos en: $global:tempBackupFolder",
            "Error permisos",
            [System.Windows.Forms.MessageBoxButtons]::OK,
            [System.Windows.Forms.MessageBoxIcon]::Error
        )
    ...
    # 4. Formulario y ProgressBar estilo Marquee
    $form = New-Object System.Windows.Forms.Form
    $form.Text            = "Procesando Backup"
    ...
    $pb.Location = New-Object System.Drawing.Point(10,20)

    $lbl = New-Object System.Windows.Forms.Label
    $lbl.Text     = "Por favor espere, realizando backup..."
    $lbl.AutoSize = $false
    ...
    $form.Controls.AddRange(@($pb,$lbl,$btnCancel))
    $form.Show()

    # 5. Configurar BackgroundWorker
    $bw = New-Object System.ComponentModel.BackgroundWorker
    $bw.WorkerSupportsCancellation = $true

    # DoWork: Ejecutar backup en otro hilo
    $bw.Add_DoWork({
        param($sender,$e)
        # Conexión SQL
    ...
    # RunWorkerCompleted: al terminar o cancelar
    $bw.Add_RunWorkerCompleted({
        param($sender,$e)
        $form.Invoke([Action]{
            if ($e.Cancelled) {
                [System.Windows.Forms.MessageBox]::Show("Backup cancelado","Info",[System.Windows.Forms.MessageBoxButtons]::OK,[System.Windows.Forms.MessageBoxIcon]::Information)
            }
            elseif ($e.Error) {
                [System.Windows.Forms.MessageBox]::Show("Error: $($e.Error.Message)","Error",[System.Windows.Forms.MessageBoxButtons]::OK,[System.Windows.Forms.MessageBoxIcon]::Error)
            }
            else {
