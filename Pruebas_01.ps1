...
############# BACKUP #############
# --- Habilitar Visual Styles para que Marquee funcione ---
...
$btnBackup.Add_Click({
    ...
    # 4. Crear formulario global con ProgressBar Marquee y tamaño aumentado
    $global:backupProgressForm = New-Object System.Windows.Forms.Form
    $global:backupProgressForm.Text            = "Procesando Backup"
    # Formulario más ancho y alto para botón visible
    ...
    $btnCancel.Location = New-Object System.Drawing.Point(
        [int](($global:backupProgressForm.ClientSize.Width - $btnCancel.Width) / 2),
        90
    )
    ...
    # 5. Iniciar Job de backup en segundo plano (Runspace propio)
    $script = {
    ...
    # 7. Cancelar el Job desde el botón
    $btnCancel.Add_Click({
