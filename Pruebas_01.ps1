...
# Crear el formulario
    ...
    $boldFont = New-Object System.Drawing.Font("Segoe UI", 10, [System.Drawing.FontStyle]::Bold)
                                                                                                        $version = "Alfa 250219.1219999"  # Valor predeterminado para la versión
        ...
        if ($databaseName) {
            ...
            try {
                ...
                if ($reader.HasRows) {
                    ...
                    $sqlScript = Get-Content -Path $datFilePath -Raw
            ...
            Write-Host "Nombre invalido para la base de datos"
