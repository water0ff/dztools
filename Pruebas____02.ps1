...
$textBoxAdapterStatus = Create-TextBox `
    ...
    -Size     (New-Object System.Drawing.Size(260, 35)) `
...
$textBoxAdapterStatus.Add_Click({
    ...
    Refresh-AdapterStatus
        ...
        $textBoxAdapterStatus.Add_MouseEnter($changeColorOnHover)
        $textBoxAdapterStatus.Add_MouseLeave($restoreColorOnLeave)
