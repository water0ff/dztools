...
$btnYes = Create-Button -Text "Sí" -Location   (New-Object System.Drawing.Point(120, 180)) -Size (New-Object System.Drawing.Size(80, 30)) `
    -BackColor  [System.Drawing.Color]::LightGreen -ForeColor  [System.Drawing.Color]::Black -ToolTipText "Confirmar acción" -Font       $defaultFont -Enabled    $true
...
$btnNo = Create-Button  -Text "No" -Location   (New-Object System.Drawing.Point(220, 180)) -Size (New-Object System.Drawing.Size(80, 30)) `
    -BackColor  [System.Drawing.Color]::LightCoral -ForeColor  [System.Drawing.Color]::Black -ToolTipText "Cancelar acción" -Font       $defaultFont -Enabled    $true
...
# URLs de descarga directa (convertidas desde Google Drive)
    ...
    if ($uploadDecision -eq [System.Windows.Forms.DialogResult]::Yes) {
        ...
        if ($missingTools.Count -gt 0) {
            $message = "Faltan herramientas necesarias:`n$($missingTools -join ", ")"
            [System.Windows.Forms.MessageBox]::Show($message, "Herramientas Faltantes", "OK", "Warning")
