...
# Crear el formulario
    ...
    $boldFont = New-Object System.Drawing.Font("Segoe UI", 10, [System.Drawing.FontStyle]::Bold)
                                                                                                        $version = "Alfa 250514.1138"  # Valor predeterminado para la versión
...
# Botón de Backup (agregar junto a los otros botones SQL)
$btnBackup = Create-Button -Text "Backup BDD" -Location (New-Object System.Drawing.Point(10, 260)) `
    -Size (New-Object System.Drawing.Size(180, 30)) `
    -BackColor ([System.Drawing.Color]::FromArgb(150, 200, 255)) `
...
############# BACKUP #############
$btnBackup.Add_Click({
    # Variables globales para control de recursos
    ...
    try {
        ...
        $selectedDb = $cmbDatabases.SelectedItem
        if (-not $selectedDb) {
            [System.Windows.Forms.MessageBox]::Show("Selecciona una base de datos primero", "Error", 
                [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Warning)
            return
        }

        # Seleccionar ubicación del backup
        $folderDialog = New-Object System.Windows.Forms.FolderBrowserDialog
        $folderDialog.Description = "Selecciona carpeta para guardar el backup"
        if ($folderDialog.ShowDialog() -ne [System.Windows.Forms.DialogResult]::OK) { return }

        # Configurar formulario de progreso
        $global:backupProgressForm = Create-Form -Title "Progreso de Backup" -Size (New-Object System.Drawing.Size(400, 150))
        $progressBar = New-Object System.Windows.Forms.ProgressBar
        $progressBar.Size = New-Object System.Drawing.Size(380, 20)
        $progressBar.Location = New-Object System.Drawing.Point(10, 20)
        $lblProgress = Create-Label -Text "0% completado" -Location (New-Object System.Drawing.Point(10, 50)) -Size (New-Object System.Drawing.Size(380, 20))
        $btnCancel = Create-Button -Text "Cancelar" -Location (New-Object System.Drawing.Point(150, 80)) -Size (New-Object System.Drawing.Size(100, 30))
        ...
        $global:backupConnection.ConnectionString = "Server=$($global:server);Database=master;User Id=$($global:user);Password=$($global:password);"
        $global:backupConnection.Open()

        # Configurar comando de backup y validar permisos
        $backupPath = Join-Path $folderDialog.SelectedPath "$selectedDb-$(Get-Date -Format 'yyyyMMdd-HHmmss').bak"
        
        # Validación de permisos de escritura (NUEVO)
        try {
            [IO.File]::WriteAllText("$backupPath.test", "test")
            Remove-Item "$backupPath.test" -Force -ErrorAction Stop
        }
        catch {
            [System.Windows.Forms.MessageBox]::Show("Error de permisos en la ruta seleccionada:`n$($folderDialog.SelectedPath)", "Error",
                [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Error)
            return
        }

        $global:backupCommand = $global:backupConnection.CreateCommand()
        $global:backupCommand.CommandText = "BACKUP DATABASE [$selectedDb] TO DISK='$backupPath' WITH STATS=1, CHECKSUM"
        ...
        $global:backupConnection.Add_InfoMessage({
            ...
            if ($e.Message -match '(\d+)% procesado') {
                ...
                $global:backupProgressForm.BeginInvoke([Action]{
                    ...
                    $lblProgress.Text = "$percent% - $($e.Message)"
                })
            }
        })
        ...
        # Configurar acción de cancelación
        $btnCancel.Add_Click({
            try {
                if ($global:backupCommand -ne $null) {
                    $global:backupCommand.Cancel()
                }
                [System.Windows.Forms.MessageBox]::Show("Backup cancelado", "Información",
                    [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Information)
            }
            finally {
                if ($global:backupTimer -ne $null) { $global:backupTimer.Stop() }
                if ($global:backupConnection -ne $null -and $global:backupConnection.State -eq 'Open') { $global:backupConnection.Close() }
                if ($global:backupProgressForm -ne $null) { $global:backupProgressForm.Close() }
            }
        })

        # Manejar finalización asíncrona
        $global:backupTimer.Add_Tick({
                if ($global:asyncResult -ne $null -and $global:asyncResult.IsCompleted) {
                    ...
                    try {
                        ...
                        # Construye el mensaje con correcta expansión
                        $msgPath = "Backup completado exitosamente en:`n$($backupPath)"
                        ...
                        if (Test-Path $backupPath) {
                            ...
                            [System.Windows.Forms.MessageBox]::Show(
                                "El comando BACKUP terminó sin errores, pero no se encontró el archivo:`n$($backupPath)`n" +
                                "Asegúrese de que la cuenta de servicio de SQL Server tenga permisos de escritura en la ruta.",
                                "Advertencia de permisos",
                                [System.Windows.Forms.MessageBoxButtons]::OK,
                                [System.Windows.Forms.MessageBoxIcon]::Warning
                            )
                            Write-Host "AVISO: No existe $backupPath; posible falta de permisos al servicio SQL." -ForegroundColor Yellow
                        }
                    }
                    catch [System.Data.SqlClient.SqlException] {
                        if ($_.Exception.Class -ne 0) {
                            [System.Windows.Forms.MessageBox]::Show(
        ...
        [System.Windows.Forms.MessageBox]::Show("Error inicializando backup: $($_.Exception.Message)", "Error",
            [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Error)
        if ($global:backupConnection -ne $null -and $global:backupConnection.State -eq 'Open') { $global:backupConnection.Close() }
        if ($global:backupProgressForm -ne $null) { $global:backupProgressForm.Close() }
    }
...
# Cierre seguro de conexiones al cerrar la aplicación
