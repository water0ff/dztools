...
#$rtbQuery.Anchor = [System.Windows.Forms.AnchorStyles]::Top -bor [System.Windows.Forms.AnchorStyles]::Left -bor [System.Windows.Forms.AnchorStyles]::Right
$rtbQuery.Size = New-Object System.Drawing.Size(750, 140)     # Mayor ancho
...
#FUERA DEL TAB
    $btnExit = Create-Button -Text "Salir" -Location (New-Object System.Drawing.Point(450, 520)) `
...
function Set-NetworkCategory {
        ...
        foreach ($adapter in $networkAdapters) {
            ...
            $lblAdaptadorStatus = Create-Label -Text $text -Location (New-Object System.Drawing.Point(10, (520 + (30 * $index)))) -Size (New-Object System.Drawing.Size(220, 20)) -BackColor ([System.Drawing.Color]::FromArgb(255, 0, 0, 0)) -ForeColor ([System.Drawing.Color]::FromArgb(255, 255, 255, 255))
...
$btnExecute.Add_Click({
    try {
        ...
        if ($result -is [hashtable]) {
            ...
            Write-Host "btn_Filas afectadas: $result" -ForegroundColor Green
        }
    }
    catch {
...
$btnConnectDb.Add_Click({
    try {
        ...
        $query = "SELECT name FROM sys.databases WHERE name NOT IN ('tempdb','model','msdb') AND state_desc = 'ONLINE' ORDER BY name"
