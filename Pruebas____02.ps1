...
# Fixed megatools download section
$megatoolsUrl = "https://github.com/megous/megatools/releases/download/1.11.1/megatools-1.11.1.20230212-win64.zip"
$megatoolsZip = "C:\Temp\megatools.zip"
$megatoolsPath = "C:\Program Files\megatools"
...
try {
    Write-Host "Descargando megatools desde: $megatoolsUrl"
    Invoke-WebRequest -Uri $megatoolsUrl -OutFile $megatoolsZip -ErrorAction Stop
    ...
    [System.Windows.Forms.MessageBox]::Show(
        "No se pudo descargar megatools. Error: $($_.Exception.Message)",
        "Error de descarga",
        [System.Windows.Forms.MessageBoxButtons]::OK,
        [System.Windows.Forms.MessageBoxIcon]::Error
    )
...
if (Test-Path $megatoolsZip) {
    try {
        Write-Host "Extrayendo megatools..."
        Expand-Archive -Path $megatoolsZip -DestinationPath $megatoolsPath -Force -ErrorAction Stop
        Write-Host "Extracción completada correctamente" -ForegroundColor Green
    }
    catch {
        Write-Host "Error al extraer: $($_.Exception.Message)" -ForegroundColor Red
        [System.Windows.Forms.MessageBox]::Show(
            "Error al extraer megatools: $($_.Exception.Message)",
            "Error de extracción",
            [System.Windows.Forms.MessageBoxButtons]::OK,
            [System.Windows.Forms.MessageBoxIcon]::Error
        )
    ...
    Write-Host "No se encontró el archivo ZIP para extraer" -ForegroundColor Yellow
}

# Agregar a PATH del sistema
$env:Path += ";$megatoolsPath"
[Environment]::SetEnvironmentVariable("Path", $env:Path + ";$megatoolsPath", "Machine")
...
$megaConfig | Out-File -FilePath $configPath -Encoding utf8
