...
$lblServer = Create-Label -Text "Instancia SQL:" -Location (10,20) -Size (100,20)
    $txtServer = Create-TextBox -Location (120,20) -Size (180,20)
$lblUser = Create-Label -Text "Usuario:" -Location (10,60) -Size (100,20)
    $txtUser = Create-TextBox -Location (120,60) -Size (180,20)
$lblPassword = Create-Label -Text "Contraseña:" -Location (10,100) -Size (100,20)
    $txtPassword = Create-TextBox -Location (120,100) -Size (180,20) -UseSystemPasswordChar $true
