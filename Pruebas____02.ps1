...
$btnInstallSQL2019.Add_Click({
    ...
    try {
            ...
            Start-Process choco -ArgumentList 'install sql-server --version=2019.20190106 -y --params "/SQLUSER:sa /SQLPASSWORD:National09 /INSTANCENAME:SQL2019 /FEATURES:SQL,SQLENGINE,CONN" ' -NoNewWindow -Wait
            Write-Host "`nInstalación completa." -ForegroundColor Green
