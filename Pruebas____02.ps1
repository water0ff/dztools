...
$btnBackup.Add_Click({
    ...
    [System.Windows.Forms.MessageBoxIcon]::Warning
        ...
        # Definir backupPath como global
        $global:backupPath = Join-Path $folderDialog.SelectedPath `
            "$selectedDb-$(Get-Date -Format 'yyyyMMdd-HHmmss').bak"

        # Validación de permisos de SQL Service: OPCIÓN 1, simple prueba de escritura
        try {
        ...
        [System.Windows.Forms.MessageBox]::Show(
        "Error de permisos en la ruta seleccionada:`n$($folderDialog.SelectedPath)",
        "Error",
        [System.Windows.Forms.MessageBoxButtons]::OK,
        [System.Windows.Forms.MessageBoxIcon]::Error)     
        return
...
# Configurar formulario de progreso
        ...
        # Tick del temporizador ➔ fin de backup
                ...
                try {
                    ...
                    if (Test-Path $global:backupPath) {
                        [System.Windows.Forms.MessageBox]::Show(
                            ...
                            "Éxito", [OK], [Information]
                        )
                    }
                    else {
                        [System.Windows.Forms.MessageBox]::Show(
                            "Backup sin errores, pero no se encontró el archivo:`n$global:backupPath",
                            "Advertencia", [OK], [Warning]
                        )
                    }
                }
                    ...
                    if ($global:backupConnection.State -eq 'Open') { $global:backupConnection.Close() }
...
$formPrincipal.Add_FormClosing({
    if ($global:backupConnection.State -eq 'Open') {
