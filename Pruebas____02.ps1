...
############# BACKUP #############
# Habilitar estilos visuales (en caso de que los necesite)
...
$btnBackup.Add_Click({
    ...
    # 4.1 Instantiate ProgressBar correctamente
