...
$btnDetenerSync.Add_Click({
    ...
    # 5. Renombrar carpeta bin (SOLUCIÓN AL ERROR - OPCIÓN 1: ESPERAR MÁS)
    ...
    try {
        if (Test-Path $marketPlaceBin) {
            ...
            # ... (código para detener procesos)

            # Esperar MUCHO más tiempo (prueba con 5, 10 o incluso 15 segundos)
