Lo raro es que primero dice que la crea (yo al entrar a un administrador de base de datos no la veo).

PS C:\Users\gerardo.zermeno> irm https://raw.githubusercontent.com/water0ff/dztools/refs/heads/main/plantilla_botones.ps1 | iex
              Versión: vbtn250207.0957
En espera de los datos de conexión
Archivo de respaldo seleccionado: C:\Users\gerardo.zermeno\OneDrive - National Soft de México S de RL de CV\Escritorio\respaldo_restcard_20250206_175401.sql
C:\Program Files (x86)\MySQL\MySQL Server 5.0\bin\mysql.exe  Ver 14.12 Distrib 5.0.41, for Win32 (ia32)
Copyright (C) 2002 MySQL AB
This software comes with ABSOLUTELY NO WARRANTY. This is free software,
and you are welcome to modify and redistribute it under the GPL license
Usage: C:\Program Files (x86)\MySQL\MySQL Server 5.0\bin\mysql.exe [OPTIONS] [database]
...
secure-auth                       FALSE
show-warnings                     FALSE
La base de datos no existe. Creando la base de datos...
C:\Program Files (x86)\MySQL\MySQL Server 5.0\bin\mysql.exe  Ver 14.12 Distrib 5.0.41, for Win32 (ia32)
Copyright (C) 2002 MySQL AB
This software comes with ABSOLUTELY NO WARRANTY. This is free software,
and you are welcome to modify and redistribute it under the GPL license
...
secure-auth                       FALSE
show-warnings                     FALSE
Base de datos 'restcard123123' creada.
ERROR 1049 (42000): Unknown database 'restcard123123'
Error: No se pudo realizar la restauración. Verifica los datos de conexión y el archivo de respaldo.
Cancel
PS C:\Users\gerardo.zermeno>
