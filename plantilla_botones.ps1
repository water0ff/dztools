...
# Crear el formulario
    ...
    $boldFont = New-Object System.Drawing.Font("Segoe UI", 10, [System.Drawing.FontStyle]::Bold)
                                                                                                        $version = "btn250205.1339"  # Valor predeterminado para la versión
        ...
        $btnModificarPermisos.Add_Click({
            ...
            try {
                ...
                foreach ($comando in $comandos) {
                    ...
                    # Ejecutar el comando con PsExec como SYSTEM (localmente)
                    $processInfo = New-Object System.Diagnostics.ProcessStartInfo
                    $processInfo.FileName = $psexecPath
                    $processInfo.Arguments = "-accepteula -s cmd.exe /c $comando"  # Ejecutar localmente como SYSTEM
