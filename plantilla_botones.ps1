...
# Crear el formulario
    ...
    $boldFont = New-Object System.Drawing.Font("Segoe UI", 10, [System.Drawing.FontStyle]::Bold)
                                                                                                        $version = "Alfa 250207.1823"  # Valor predeterminado para la versión
...
$btnChangeConfig.Add_Click({
    ...
    # Detectar archivos INI por contenido (más confiable que por nombre)
    $iniSQLFile = $iniFiles | Where-Object { Select-String -Path $_.FullName -Pattern "SQL" -Quiet }
    $iniDBFFile = $iniFiles | Where-Object { Select-String -Path $_.FullName -Pattern "DBF" -Quiet }
