...
# Crear el formulario
    ...
    $boldFont = New-Object System.Drawing.Font("Segoe UI", 10, [System.Drawing.FontStyle]::Bold)
                                                                                                        $version = "Alfa 250207.1817777"  # Valor predeterminado para la versión
...
$btnChangeConfig.Add_Click({
    ...
    if (Test-Path $syscfgPath) {
        ...
        # Validar que los archivos INI existan antes de continuar
        if (-not $iniSQLFile -or -not $iniDBFFile) {
            ...
            Write-Host "`tError: No se encontraron los archivos INI esperados en $iniPath." -ForegroundColor Red
            return
        }
        ...
        if ($result -eq [System.Windows.Forms.DialogResult]::Yes) {
            ...
            Write-Host "`tRenombrando archivos INI..." -ForegroundColor Cyan
            ...
            try {
                ...
                Write-Host "`tError al renombrar los archivos: $_" -ForegroundColor Red
                [System.Windows.Forms.MessageBox]::Show("Error al renombrar los archivos INI: $_", "Error", [System.Windows.Forms.MessageBoxButtons]::OK)
                return
            }
