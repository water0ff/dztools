...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Background="Transparent">
        <Window.Resources>
        <!-- Quita el azul cielo del highlight del sistema (solo en esta ventana) -->
                        ...
                        <ControlTemplate TargetType="ComboBoxItem">
                            ...
                            <ControlTemplate.Triggers>
                                ...
                                <Trigger Property="IsHighlighted" Value="True">
                                    <Setter TargetName="Bd" Property="Background" Value="$($theme.FormBackground)"/>
                                    <Setter Property="Foreground" Value="$($theme.ControlForeground)"/>
                                </Trigger>
                                ...
                                <!-- Si quieres “marcar” sin cambiar texto a blanco -->
                                <MultiTrigger>
                                    <MultiTrigger.Conditions>
                                        <Condition Property="IsSelected" Value="True"/>
                                        <Condition Property="IsHighlighted" Value="True"/>
                                    </MultiTrigger.Conditions>
                                    <Setter TargetName="Bd" Property="Background" Value="$($theme.ControlBackground)"/>
                                </MultiTrigger>
                            </ControlTemplate.Triggers>
                        </ControlTemplate>
                    </Setter.Value>
            ...
            try {
                ...
                try {
                    Get-LocalGroupMember -Group $adminGroupName -ErrorAction Stop | ForEach-Object {
                        # Name suele venir como "EQUIPO\usuario" o "usuario"
                        $n = $_.Name
