...
$btnCreateDatabaseFromDat = Create-Button -Text "Crear BDD desde .dat" -Location (New-Object System.Drawing.Point(240, 90)) `
    -BackColor ([System.Drawing.Color]::FromArgb(150, 200, 255)) -ToolTip "Crear una base de datos desde un archivo .dat."

# Agregar el botón a la pestaña Pro
$tabProSql.Controls.Add($btnCreateDatabaseFromDat)

# Evento para el botón "Crear BDD desde .dat"
$btnCreateDatabaseFromDat.Add_Click({
    ...
    if ($result -eq [System.Windows.Forms.DialogResult]::OK) {
        ...
        $databaseName = [System.Windows.Forms.MessageBox]::Show(
        ...
        if ($databaseName -eq [System.Windows.Forms.DialogResult]::OK) {
            $databaseName = [Microsoft.VisualBasic.Interaction]::InputBox("Nombre de la base de datos:", "Nombre de la base de datos")
            ...
            if (-not [string]::IsNullOrEmpty($databaseName)) {
                ...
                try {
                    ...
                    if ($reader.HasRows) {
                        [System.Windows.Forms.MessageBox]::Show(
                            "La base de datos '$databaseName' ya existe. Por favor, elija otro nombre.",
                            "Error",
                            [System.Windows.Forms.MessageBoxButtons]::OK,
                            [System.Windows.Forms.MessageBoxIcon]::Error
                        )
                        ...
                        # Leer el archivo .dat y ejecutar los scripts SQL
                    ...
                    [System.Windows.Forms.MessageBox]::Show(
                        "Error al crear la base de datos: $($_.Exception.Message)",
                        "Error",
                        [System.Windows.Forms.MessageBoxButtons]::OK,
                        [System.Windows.Forms.MessageBoxIcon]::Error
                    )
                ...
                [System.Windows.Forms.MessageBox]::Show(
                    "Debe ingresar un nombre válido para la base de datos.",
                    "Error",
                    [System.Windows.Forms.MessageBoxButtons]::OK,
                    [System.Windows.Forms.MessageBoxIcon]::Error
                )
